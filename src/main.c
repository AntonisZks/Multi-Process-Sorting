...
void printApplicationUsage(const char* appName);
boolean getCommandLineArguments(int argc, char** argv, char** file, unsigned int* processes, char** sorting1, char** sorting2);
...
int main(int argc, char* argv[])
{
    ...
    getCommandLineArguments(argc, argv, &dataFileName, &numberOfChildren, &sortingAlgorithm1, &sortingAlgorithm2);

    printf("File: %s\nProcesses: %d\nSorting1: %s\nSorting2: %s\n", dataFileName, numberOfChildren, sortingAlgorithm1, sortingAlgorithm2);
